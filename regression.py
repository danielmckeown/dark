...
import sqlite3
conn = sqlite3.connect('darkmatter.db')    #Here I will create a database of thousands of darkmatters

c = conn.cursor()   #my cursor

# Create table
c.execute('''CREATE TABLE DarkHalo135
...
for x in list_of_darkhalos:
	...
	query_string = 'INSERT INTO DarkHalo135 VALUES (%s);' % halo_string
